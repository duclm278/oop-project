...
public class SearchScreenController implements Initializable {
	...
	@FXML Button backToHomeButton;
	@FXML MenuItem about;
	
	@FXML MenuButton byCityButton;
	@FXML MenuItem byHanoiItem;
	@FXML MenuItem byHueItem;
	@FXML MenuItem byDanangItem;
	@FXML MenuItem byHCMItem;
	
	@FXML MenuButton byProvinceButton;
	@FXML MenuItem byAnGiangItem;
	@FXML MenuItem byCanThoItem;
	@FXML MenuItem byCaoBangItem;
	@FXML MenuItem byDongNaiItem;
	@FXML MenuItem byDongThapItem;
	@FXML MenuItem byLaoCaiItem;
	@FXML MenuItem byNgheAnItem;
	@FXML MenuItem byNinhBinhItem;
	@FXML MenuItem byNinhThuanItem;
	@FXML MenuItem byQuangBinhItem;
	@FXML MenuItem byQuangTriItem;
	@FXML MenuItem byTayNinhItem;
	@FXML MenuItem byThaiNguyenItem;
	@FXML MenuItem byVinhPhucItem;
	
	@FXML Button byMemoButton;
	@FXML Button byBeachButton;
	@FXML Button byEventButton;
	@FXML Button byVenueButton;
	@FXML Button byGardenButton;
	@FXML Button byLakeButton;
	@FXML Button byLandmarkButton;
	@FXML Button byMuseumButton;
	@FXML Button byPagodaButton;
	@FXML Button byParkButton;
	@FXML Button byProtectedAreaButton;
	@FXML Button byReligousBuildingButton;
	@FXML Button byCaveButton;
	@FXML Button bySquareButton;
	@FXML Button byWaterfallButton;
	@FXML Button byOtherButton;
	...
	public void showWarningAlert(Exception e) {
		Alert alert = new Alert(AlertType.WARNING);
		alert.setTitle("Query failed");
		alert.setHeaderText("Query failed due to:");
	...
	public void search(ActionEvent event, ICrawler crawler) {
		...
		if(confirm) {
			...
			showInfoAlert();
				...
				showWarningAlert(e);
				try {
				PrintWriter pw = new PrintWriter(new File(fileSaveLocation + "/bug.log"));
	...
	public void searchByDongNai(ActionEvent event) {
		search(event, new QueryByProvince("�?ồng Nai province"));
	}

	public void searchByDongThap(ActionEvent event) {
		search(event, new QueryByProvince("�?ồng Tháp province"));
	}
